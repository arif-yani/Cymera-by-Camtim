...
//        func cameraBack() -> AVCaptureDevice.DiscoverySession {
//            let discoverSessionBack = AVCaptureDevice.DiscoverySession.init(deviceTypes: [.builtInWideAngleCamera], mediaType: .video, position: .back)
//            return discoverSessionBack
//        }
        let discoverSessionBack = AVCaptureDevice.DiscoverySession.init(deviceTypes: [.builtInWideAngleCamera], mediaType: .video, position: .back)
        let devices = discoverSessionBack.devices
